...
object WorkerModule extends ZincWorkerModule {
  def repositories() = super.repositories ++ Seq(
    ...
    MavenRepository("https://build.shibboleth.net/nexus/content/repositories/releases")
  )
}
...
object cmwell extends ScalaModule with ScalafmtModule {
  ...
  def ivyDeps = Agg(
    ...
    ivy"com.tinkerpop.blueprints:blueprints-core:${Versions.gremlin}",
    ivy"com.tinkerpop.gremlin:gremlin-groovy:${Versions.gremlin}",
    ...
    ivy"org.apache.abdera:abdera-core:1.1.3",
    ...
    ivy"org.pac4j:play-pac4j:4.1.1",
    ivy"org.pac4j:pac4j-saml:${Versions.pac4j}",
    ...
    ivy"com.twitter::chill-akka:0.9.5",
  ...
  object test extends Tests {
    def ivyDeps = Agg(
      ...
      ivy"org.slf4j:jul-to-slf4j:${Versions.slf4j}",
      ivy"org.slf4j:log4j-over-slf4j:${Versions.slf4j}",
    )
